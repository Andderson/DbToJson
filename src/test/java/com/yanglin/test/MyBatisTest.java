...
public class MyBatisTest {
            ...
            for (String reportNo : distinctReportNo) {
                ...
                if (lossInfo != null && lossInfo.size() > 0) {
                    for (Lossaccessment lossaccessment : lossInfo) {
                        ...
                        // 定损信息 开始
                        // 定损险种
                        if (lossaccessment.getDingsunxianzhong() != null) {
                            String temp = lossaccessment.getDingsunxianzhong();
                            // lossAssessmentInfo.setLossAssessmentInsuranceTypeName(lossaccessment.getDingsunxianzhong());
                            if ("A".equals(temp)) {
                                lossAssessmentInfo.setLossAssessmentInsuranceTypeName("机动车损失保险条款");
                            }else if ("B".equals(temp)) {
                                lossAssessmentInfo.setLossAssessmentInsuranceTypeName("机动车第三者责任保险条款");
                            }else if ("BZ".equals(temp)) {
                                lossAssessmentInfo.setLossAssessmentInsuranceTypeName("机动车交通事故责任强制险条款");
                            }else if ("C2".equals(temp)) {
                                lossAssessmentInfo.setLossAssessmentInsuranceTypeName("代步机动车服务特约条款");
                            } else if ("C5".equals(temp)) {
                                lossAssessmentInfo.setLossAssessmentInsuranceTypeName("异地出险住宿费特约条款");
                            } else if ("C8".equals(temp)) {
                                lossAssessmentInfo.setLossAssessmentInsuranceTypeName("法律费用特约条款");
                            } else if ("D1".equals(temp)) {
                                lossAssessmentInfo.setLossAssessmentInsuranceTypeName("机动车车上人员责任保险条款");
                            } else if ("D2".equals(temp)) {
                                lossAssessmentInfo.setLossAssessmentInsuranceTypeName("车上货物责任险条款");
                            } else if ("D3".equals(temp)) {
                                lossAssessmentInfo.setLossAssessmentInsuranceTypeName("机动车车上人员责任保险（驾驶员）");
                            } else if ("D4".equals(temp)) {
                                lossAssessmentInfo.setLossAssessmentInsuranceTypeName("机动车车上人员责任保险（乘客）");
                            } else if ("E".equals(temp)) {
                                lossAssessmentInfo.setLossAssessmentInsuranceTypeName("火灾、爆炸、自燃损失险条款");
                            }else if("F".equals(temp)){
                                lossAssessmentInfo.setLossAssessmentInsuranceTypeName("玻璃单独破碎险条款");
                            }else if("G1".equals(temp)){
                                lossAssessmentInfo.setLossAssessmentInsuranceTypeName("机动车盗抢保险条款");
                            }else if("G4".equals(temp)){
                                lossAssessmentInfo.setLossAssessmentInsuranceTypeName("租车人人车失踪险条款");
                            }else if("K1".equals(temp)){
                                lossAssessmentInfo.setLossAssessmentInsuranceTypeName("起重、装卸、挖掘车辆损失扩展条款");
                            }else if("K2".equals(temp)){
                                lossAssessmentInfo.setLossAssessmentInsuranceTypeName("特种车辆固定设备、仪器损坏扩展条款");
                            }else if("L".equals(temp)){
                                lossAssessmentInfo.setLossAssessmentInsuranceTypeName("车身划痕损失险条款");
                            }else if("M".equals(temp)){
                                lossAssessmentInfo.setLossAssessmentInsuranceTypeName("不计免赔率险条款");
                            }else if("NX".equals(temp)){
                                lossAssessmentInfo.setLossAssessmentInsuranceTypeName("新车特约条款A");
                            }else if("NY".equals(temp)){
                                lossAssessmentInfo.setLossAssessmentInsuranceTypeName("新车特约条款B");
                            }else if("Q".equals(temp)){
                                lossAssessmentInfo.setLossAssessmentInsuranceTypeName("可选免赔额特约条款");
                            }else if("Q1".equals(temp)){
                                lossAssessmentInfo.setLossAssessmentInsuranceTypeName("多次出险增加免赔率特约条款");
                            }else if("Q3".equals(temp)){
                                lossAssessmentInfo.setLossAssessmentInsuranceTypeName("指定修理厂险条款");
                            }else if("Q4".equals(temp)){
                                lossAssessmentInfo.setLossAssessmentInsuranceTypeName("修理期间费用补偿险条款");
                            }else if("Q5".equals(temp)){
                                lossAssessmentInfo.setLossAssessmentInsuranceTypeName("机动车损失保险无法找到第三方特约险条款");
                            }else if("R".equals(temp)){
                                lossAssessmentInfo.setLossAssessmentInsuranceTypeName("精神损害抚慰金责任险条款");
                            }else if("S".equals(temp)){
                                lossAssessmentInfo.setLossAssessmentInsuranceTypeName("附加机动车出境保险条款");
                            }else if("T".equals(temp)){
                                lossAssessmentInfo.setLossAssessmentInsuranceTypeName("机动车停驶损失险条款");
                            }else if("U".equals(temp)){
                                lossAssessmentInfo.setLossAssessmentInsuranceTypeName("附加换件特约条款");
                            }else if("V1".equals(temp)){
                                lossAssessmentInfo.setLossAssessmentInsuranceTypeName("附加油污污染责任保险条款");
                            }else if("W1".equals(temp)){
                                lossAssessmentInfo.setLossAssessmentInsuranceTypeName("更换轮胎服务特约条款");
                            }else if("W2".equals(temp)){
                                lossAssessmentInfo.setLossAssessmentInsuranceTypeName("送油、充电服务特约条款");
                            }else if("W3".equals(temp)){
                                lossAssessmentInfo.setLossAssessmentInsuranceTypeName("拖车服务特约条款");
                            }else if("W4".equals(temp)){
                                lossAssessmentInfo.setLossAssessmentInsuranceTypeName("随车行李物品损失保险条款");
                            }else if("W5".equals(temp)){
                                lossAssessmentInfo.setLossAssessmentInsuranceTypeName("约定区域通行费用特约条款");
                            }else if("X".equals(temp)){
                                lossAssessmentInfo.setLossAssessmentInsuranceTypeName("新增加设备损失保险条款");
                            }else if("X1".equals(temp)){
                                lossAssessmentInfo.setLossAssessmentInsuranceTypeName("发动机涉水损失险条款");
                            }else if("Y3".equals(temp)){
                                lossAssessmentInfo.setLossAssessmentInsuranceTypeName("教练车特约条款");
                            }else if("Z".equals(temp)){
                                lossAssessmentInfo.setLossAssessmentInsuranceTypeName("自燃损失险条款");
                            }
                        ...
                        lossAssessmentInfo
                                .setLossAssessmentTotalRemainedValue(lossaccessment.getDingsunZongcanzhijine().doubleValue());
                        ...
                        // 定损车辆信息 开始
                        LossaccessmentVehicle lossaccessmentVehicle = userServiceI.getVehicleInfoByClaimAndBrandNumber(reportNo,
                                chepaihao);
                        if (lossaccessmentVehicle != null) {
                            ...
                            if (lossaccessmentVehicle.getCheliangZhonglei() != null) {
                                // if
                                // ("客车".equals(lossaccessmentVehicle.getCheliangZhonglei()))
                                // {
                                // vehicleInfo.
                                // }else if
                                // ("拖拉机".equals(lossaccessmentVehicle.getCheliangZhonglei()))
                                // {
                                //
                                // }else if
                                // ("两轮摩托车".equals(lossaccessmentVehicle.getCheliangZhonglei()))
                                // {
                                //
                                // }
                        ...
                        // 获取工时信息 开始
                        List<LossaccessmentLabors> lossaccessmentLabors = userServiceI
                                .getLossLaborByClaimAndVehicleNumber(reportNo, chepaihao);
                        if (lossaccessmentLabors != null && lossaccessmentLabors.size() > 0) {
                            ...
                            for (int i = 0; i < lossaccessmentLabors.size(); i++) {
                                ...
                                // 工时--备注
                                if (lossaccessmentLabors.get(i).getBeizhu() != null
                                        && !"-".equals(lossaccessmentLabors.get(i).getBeizhu())) {
                        ...
                        // 获取配件信息 开始
                        List<LossaccessmentSpareparts> lossaccessmentSpareparts = userServiceI
                                .getSparepartsByClaimAndVehicleNumber(reportNo, chepaihao);
                        if (lossaccessmentSpareparts != null && lossaccessmentSpareparts.size() > 0) {
                            ...
                            for (int i = 0; i < lossaccessmentSpareparts.size(); i++) {
                                ...
                                // System.out.println("配件中的单价： " + reportNo + "
                                // " +
                                // lossaccessmentSpareparts.get(i).getDanjia().floatValue());
                                ...
                                sparePartPriceInfo
                                        .setSubTotalPrice(lossaccessmentSpareparts.get(i).getXiaojiJine().doubleValue());
                        ...
                        // 定损信息-定核损意见信息 开始
                        List<LossaccessmentOpinions> lossOptions = userServiceI.getLossOptionsByClaimAndVehicleNumber(reportNo,
                                chepaihao);
                        ...
                        // 人伤信息 开始
                        LossaccessmentCasualites lossaccessmentCasualites = userServiceI
                                .getLossaccessmentCasualitesByClaimnumber(reportNo);
                        if (lossaccessmentCasualites != null) {
                            ...
                            if (lossaccessmentCasualites.getShangwangLeibie() != null) {
                                // if
                                // ("伤".equals(lossaccessmentCasualites.getShangwangLeibie()))
                                // {
                                //
                                // }else if
                                // ("".equals(lossaccessmentCasualites.getShangwangLeibie()))
                                // {
                                //
                                // }else {
                                //
                        ...
                        if (surveyInfo != null) {
                            ...
                            if (StringUtils.isNotBlank(surveyInfo.getXieshangjiakoubili())) {
                                ...
                                investigationInfo
                                        .setNegotiateDeductProportion(Double.valueOf(surveyInfo.getXieshangjiakoubili()));
                            }
                            // 理赔类型
                            ...
                            if (surveyInfo.getDisanfangCheliangshu() != null) {
                                ...
                                investigationInfo
                                        .setThirdPartyVehicleCount(Integer.valueOf(surveyInfo.getDisanfangCheliangshu()));
                            }
                            ...
                            if (surveyInfo.getShifouYidongduanchuli() != null) {
                                ...
                                if ("是".equals(surveyInfo.getShifouYidongduanchuli())) {
                                    // System.out.println("查勘：是否移动端处理：
                                    // "+reportNo + " ; " +
                                    // surveyInfo.getShifouYidongduanchuli());
    ...
    public void methodsTest() {
        // List<ClaimReportInfo> claimReportInfos =
        // userServiceI.getReportInfo("R020105222016003003");
        // System.out.println(claimReportInfos.size());

        // Lossaccessment lossaccessment =
        // userServiceI.getLossInfoByClaimAndVehicleNumber("R020105222016003003",
        // "鲁A23992");
        // System.out.println(lossaccessment.getChepaihao());
        //
        // List<Lossaccessment> lossaccessments =
        // userServiceI.getLossInfo("R020105222016003003");
        // System.out.println(lossaccessments.size());

        // LossaccessmentLabors lossaccessmentLabors =
        // userServiceI.getLossLaborByClaimAndVehicleNumber("R190105242016000001",
        // "鲁A29922");
        // System.out.println(lossaccessmentLabors.getGongshiMingcheng());

        // List<LossaccessmentSpareparts> lossaccessmentSpareparts =
        // userServiceI.getSparepartsByClaimAndVehicleNumber("R110705082016000002",
        // "黑FSA3322");
        // System.out.println(lossaccessmentSpareparts.size());

        // LossaccessmentCasualites lossaccessmentCasualites =
        // userServiceI.getLossaccessmentCasualitesByClaimnumber("R110705082016000002");
        // System.out.println(lossaccessmentCasualites.getShangwangLeibie());

        // LossaccessmentVehicle vehicleInfoByClaimAndBrandNumber =
        // userServiceI.getVehicleInfoByClaimAndBrandNumber("R080105222016000004","鲁HH5821");
        // System.out.println(vehicleInfoByClaimAndBrandNumber.getBaoanhao());

        // List<Reportinfo> reportinfos =
        // userServiceI.getReportInfoByClaimNumber("R020105082016000002");
        // System.out.println(reportinfos.size());
        // SurveyInfo surveyInfo =
        // userServiceI.getSurveyInfoByClaimAndVehicleNumber("R190105222016000102",
        // "京P152525");
        // System.out.println(surveyInfo.getChakanBaogao());

        // LossaccessmentOpinions lossOptions =
        // userServiceI.getLossOptionsByClaimAndVehicleNumber("80105072016000003",
        // "鲁A00329");
        // System.out.println(lossOptions.getHesunren());
        // List<String> baoDanListByClaimNumber =
        // userServiceI.getBaoDanListByClaimNumber("R020105082016000002");
        // System.out.println(baoDanListByClaimNumber.get(1));

        // PolicyCategory banDanInfoByBaodanhao =
        // userServiceI.getBanDanInfoByBaodanhao("1080105072013000004YD");
        ...
        // List<HistorycaseInfo> lishiPeianLiebiao =
        // userServiceI.getLishiPeianLiebiao("1110705072015400055YD");
